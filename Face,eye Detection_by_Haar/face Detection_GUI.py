...
file_name=("./ai_cv/image/marathon_01.jpg")
title_name='Haar cascade object detection'
frame_width = 500

def selectFile():
    file_name =  filedialog.askopenfilename(initialdir = "./ai_cv/image",title = "Select file",filetypes = (("jpeg files","*.jpg"),("all files","*.*")))
...
read_image = cv2.imread("./ai_cv/image/marathon_01.jpg")
(height, width) = read_image.shape[:2]
